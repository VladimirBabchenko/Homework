...
<<<<<<< HEAD
var archangel = new MilitaryResource("archangel", 150, 800, 3500,  "/src/img/paladin.png");
var newarchangel = archangel.clone();
console.log(archangel.isReadyToFight(300));
console.log(archangel);
console.log(newarchangel);
=======
// battleTeams.fight();
>>>>>>> 268f9b87abe8246c5517d47b129c1b3ef7175300
